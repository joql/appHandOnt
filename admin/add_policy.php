        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div id="gg"></div>
                    <div class="alert alert-success" role="alert">凯易科技提供了三种储存途径。<br><strong>七牛:</strong>
                    ...
                    <br><strong>远程:</strong>
                    如果你有其他空闲服务器，你可以在其上面搭建凯易科技文件存储服务，将文件存储在远程服务器，不消耗本地服务器流量、存储空间。
                    远程服务器搭建教程请联系技术QQ:592850
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
  ...
  <div class="col-sm-6 col-md-4">
    ...
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <p>使用凯易科技提供的服务端脚本，你可以将文件存放在远程服务器上。</p>
            ...
            <div class="row">
                <div class="col-lg-2" align="right">
                 ...
                 <input type="text" name="p_server" class="form-control">
                    ...
                    <div class="col-lg-3" align="right">
                <div class="sm" align="left">远程服务器接口URL，比如PHP接口：http://v513.com/fileServer.php
            ...
            <div class="row">
                <div class="col-lg-2" align="right">
                 ...
                 <input type="text" name="kjurl" class="form-control">
                    ...
                    <div class="col-lg-3" align="right">
              <div class="sm" align="left">外链的根URL，即一个上传文件后生成的外链除去文件名剩余部分。比如，你设置的储存目录为/data目录，远程服务器域名为www.592850.com，则你的外链URL为http://www.592850.com/data/,<strong>只需填写主体部分，开头无需加“http://”，结尾无需加“/”</strong></div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-2" align="right">
                 ...
                 <input type="text" name="kjurl" class="form-control">
                    ...
                    <div class="col-lg-3" align="right">
              <div class="sm" align="left">外链的根URL，即一个上传文件后生成的外链除去文件名剩余部分。比如，你设置的储存目录为/data目录，你凯易科技站点域名为www.592850.com，则你的外链URL为http://www.592850.com/data/,<strong>只需填写主体部分，开头无需加“http://”，结尾无需加“/”</strong></div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-2" align="right">
                 ...
                 <input type="text"  value="uploads"name="p_dir"class="form-control">
                    ...
                    <div class="col-lg-3" align="right">
                <div class="sm" align="left">文件存放目录，相对于凯易科技主目录的位置。<strong>开始与结尾都无需加"/"</strong>.比如，将文件存放在与首页同级目录的子目录中，只需填写data/dir2</div>
                    </div>
                <div style="height:10px;"></div>             
            </div>
              <div class="row">
