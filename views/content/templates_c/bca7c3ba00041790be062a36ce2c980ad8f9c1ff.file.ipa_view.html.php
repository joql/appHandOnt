<?php /* Smarty version Smarty-3.1.18, created on 2018-02-03 12:59:55
         compiled from ".\..\content\themes\default\ipa_view.html" */ ?>
<?php /*%%SmartyHeaderCode:270995a75b24b5861c4-40856923%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bca7c3ba00041790be062a36ce2c980ad8f9c1ff' => 
    array (
      0 => '.\\..\\content\\themes\\default\\ipa_view.html',
      1 => 1458246586,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '270995a75b24b5861c4-40856923',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a75b24b979fe7_27526497',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a75b24b979fe7_27526497')) {function content_5a75b24b979fe7_27526497($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
       ...
       <div align="center">
        <form id="bd" class="form-inline" method="post"> 
         <table width="500">
          <tbody>
           <tr>
            <td width="191"> <label for="fname">请写IPA签名包名称：</label></td>
            <td width="244"> 
             <div class="form-group"> 
              <div class="input-group"> 
...
$.post("../includes/ipa_share.php", $("#bd").serialize(),
	function(data){
   	var ge=data.split(".");
   	var ftype=ge[0];
   	var result=ge[1];
