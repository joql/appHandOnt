<?php /* Smarty version Smarty-3.1.18, created on 2018-02-03 12:12:08
         compiled from ".\..\content\themes\default\apk_view.html" */ ?>
<?php /*%%SmartyHeaderCode:130395a75a71846d2d1-16054776%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd11e290d33fdf630a61c3ba15c36efd7fc885b42' => 
    array (
      0 => '.\\..\\content\\themes\\default\\apk_view.html',
      1 => 1458246604,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '130395a75a71846d2d1-16054776',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a75a7189403d2_25858773',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a75a7189403d2_25858773')) {function content_5a75a7189403d2_25858773($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
       ...
       <div align="center">
        <form id="bd" class="form-inline" method="post"> 
         <table width="500">
          <tbody>
           <tr>
            <td width="191"> <label for="fname">给你分享的安卓文件起个名字：</label></td>
            <td width="244"> 
             <div class="form-group"> 
              <div class="input-group"> 
...
$.post("../includes/apk_share.php", $("#bd").serialize(),
	function(data){
   	var ge=data.split(".");
   	var ftype=ge[0];
   	var result=ge[1];
