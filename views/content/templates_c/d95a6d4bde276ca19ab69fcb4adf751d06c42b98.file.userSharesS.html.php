<?php /* Smarty version Smarty-3.1.18, created on 2016-03-12 04:40:37
         compiled from ".\..\content\themes\default\userSharesS.html" */ ?>
<?php /*%%SmartyHeaderCode:2702856e32d45783386-83965800%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd95a6d4bde276ca19ab69fcb4adf751d06c42b98' => 
    array (
      0 => '.\\..\\content\\themes\\default\\userSharesS.html',
      1 => 1454726140,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2702856e32d45783386-83965800',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56e32d457d1f96_46468382',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56e32d457d1f96_46468382')) {function content_56e32d457d1f96_46468382($_smarty_tpl) {?><title>私密分享 - <?php echo $_smarty_tpl->tpl_vars['tit']->value;?>
</title> 
...
');"class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> 删除</button> <a href="../s.php?k=<?php echo $_smarty_tpl->tpl_vars['filedata']->value[$_smarty_tpl->getVariable('smarty')->value['section']['two']['index']]['sskey'];?>
  ...
  function delall(){
     var chk_value =[];//定义一个数组    
            ...
            for(key1 in chk_value){ 
                $.post("../includes/userAction.php",{key: chk_value[key1],action: "delshares"},
  function(data){
    var pe=data.split(".");
    if(pe[0]=="ok"){ 
    }else{ 
...
$.post("../includes/userAction.php",{key: key1,action: "delshares"},
  function(data){
    var pe=data.split(".");
    if(pe[0]=="ok"){ 
alert(pe[1]);
