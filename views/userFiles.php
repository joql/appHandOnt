...
$fileData = array();
$fileDataOne = array();
$result2 = mysqli_query($con,"SELECT * FROM `sd_file` where upuser = '$uid' and cishuo = '0' ORDER BY `id` DESC");
...
$smarty->assign("jscode", 'Powerd by <a target="_blank" href="http://v513.com">凯易科技</a> '.$jscode); 
